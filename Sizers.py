...
class MainWindow(wx.Frame):
    def __init__(self, parent, title):
        ...
        lbl3 = wx.StaticText(posPnl, label="Position")
        lbl4 = wx.StaticText(posPnl, label="Position")
        lbl5 = wx.StaticText(posPnl, label="Position")
        ...
        posPnlSzr.Add(lbl3, 1, wx.GROW)
        posPnlSzr.Add(lbl4, 1, wx.GROW)
        posPnlSzr.Add(lbl5, 1, wx.GROW)
