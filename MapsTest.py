...
class Icon:
    ...
    def __init__(self,id='icon'):
	    ...
	    #self.image = "PlaneImage.png"
        self.shadow = ""
		
		
	self.image = ""
        #self.image = wx.Image("PlaneImage.png",wx.BITMAP_TYPE_ANY).ConvertToBitmap()
...
class Map:
    def __init__(self,id="map",pointlist=None):
        ...
        self.center   = (50,50)     # center map latitude coordinate
...
if __name__ == "__main__":
   ...
   # g.key = "AIzaSyBHpCyQYJ0p5GtkszIEWPIGoppDbwNzzrU"
    g.maps[0].zoom = 5
    q = [1,1]                           # create a marker with the defaults
    r = [50,50,'','icon2']                # icon2.id, specify the icon but no text
